    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-purple-50 relative">
              ...
              {navSections.map((section) => (
                <button
                  ...
                  className={`capitalize text-sm font-medium transition-all duration-300 relative group ${
                    activeSection === section.id ? 'text-pink-600' : 'text-gray-600 hover:text-pink-500'
                  }`}
                >
                  {section.label}
      ...
      <section id="hero" className="min-h-screen flex items-center justify-center pt-20 px-4 relative">
        ...
        >
          ...
          >
            ...
            >
              <Star className="absolute top-4 right-1/3 text-yellow-400" size={28} />
            </motion.div>
            <motion.div
              animate={{ 
                scale: [1, 1.2, 1],
            ...
            >
              <Heart className="absolute bottom-4 left-1/3 text-pink-400" size={24} />
            </motion.div>
          </motion.div>
          ...
          >
            Passionate CS student turning ideas into reality with code & creativity
          </motion.p>
          ...
          >
            ...
            <div className="flex items-center space-x-3 bg-white/50 backdrop-blur-sm px-6 py-3 rounded-full shadow-lg">
              ...
              <span>yocorangelo18@gmail.com</span>
            </div>
          </motion.div>
      ...
      {/* About Section */}
          <section id="about" className="relative">
            ...
            About Me
                <Heart className="inline-block ml-3 text-pink-500 animate-pulse" size={40} />
          </h2>
              <Card className="bg-white/80 backdrop-blur-lg border-pink-100/50 shadow-2xl rounded-3xl transform hover:scale-[1.02] transition-all duration-500">
                ...
                I'm a dedicated computer science student with hands-on experience in software, web, and mobile app
                development. I'm skilled in modern frameworks and passionate about creating innovative, user-centered
                solutions that make a difference. When I'm not coding, you'll find me exploring new technologies and
          ...
          <section id="skills" className="relative py-20">
            ...
            <div className="relative">
              ...
              <p className="text-center text-lg text-gray-500 mb-10">Technologies I use most often</p>
                    ...
                    {skills.map((skill, index) => (
                      <motion.div
                        ...
                        whileHover={{
                          ...
                          boxShadow: `0 0 0 8px ${index % 2 === 0 ? '#ec4899AA' : '#a78bfaAA'},
                            ${
                              skill === 'JavaScript' ? '0 0 0 16px #F7DF1E55' :
                              skill === 'React' || skill === 'React Native' ? '0 0 0 16px #61DAFB55' :
                              skill === 'Next.js' ? '0 0 0 16px #33333355' :
                              skill === 'MongoDB' ? '0 0 0 16px #13AA5255' :
                              skill === 'Prisma' ? '0 0 0 16px #2D374855' :
                              skill === 'Express.js' ? '0 0 0 16px #0005' :
                              skill === 'Unity' ? '0 0 0 16px #0005' :
                              skill === 'Flask' ? '0 0 0 16px #0005' :
                              skill === 'PHP' ? '0 0 0 16px #777BB455' :
                              skill === 'MySQL' ? '0 0 0 16px #4479A155' :
                              ''
                            }`,
                          y: -16,
                        }}
                        ...
                        className={`w-20 h-20 relative bg-transparent rounded-2xl shadow-lg p-4 flex items-center justify-center border-2 transition-all duration-300
                          ${index % 2 === 0 ? 'border-pink-300' : 'border-purple-300'}
      ...
      {/* Experience Section */}
          <section id="experience" className="relative">
            ...
            <div className="relative">
              <h2 className="text-5xl font-bold text-gray-800 mb-8">
            Experience
                <Briefcase className="inline-block ml-3 text-pink-500" size={40} />
          </h2>
              <Card className="bg-white/80 backdrop-blur-lg border-pink-100/50 shadow-2xl rounded-3xl transform hover:scale-[1.02] transition-all duration-500">
                <CardContent className="p-12">
                ...
                <div className="flex-1">
                    ...
                    Internship at Texwipe Asia Advanced Molding Company, Inc.
                  </h3>
                      <Badge variant="secondary" className="bg-gradient-to-r from-pink-100 to-purple-100 text-pink-700 px-6 py-2 text-lg mb-6">
                    Feb – Apr 2025
                  </Badge>
                      <ul className="text-gray-700 space-y-4 text-lg">
                        <li className="flex items-center space-x-3">
                          <div className="w-2 h-2 bg-pink-500 rounded-full" />
                          <span>Developed backend modules using PHP, MySQL, and Flask</span>
                        </li>
                        <li className="flex items-center space-x-3">
                          <div className="w-2 h-2 bg-pink-500 rounded-full" />
                        ...
                        <li className="flex items-center space-x-3">
                          <div className="w-2 h-2 bg-pink-500 rounded-full" />
                          <span>Collaborated with cross-functional teams on various projects</span>
                        </li>
                  </ul>
                </div>
              </div>
          ...
          <section id="education" className="relative">
            ...
            <div className="relative">
              <h2 className="text-5xl font-bold text-gray-800 mb-8">
                Education
                <GraduationCap className="inline-block ml-3 text-pink-500" size={40} />
          </h2>
                    ...
                    <CardContent className="p-8">
                      <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                        <div>
                          ...
                          <p className="text-pink-600 font-medium text-lg">{edu.degree}</p>
                        </div>
                        <Badge variant="secondary" className="bg-gradient-to-r from-pink-100 to-purple-100 text-pink-700 px-6 py-2 text-lg mt-4 md:mt-0">
                          {edu.period}
                        </Badge>
                      </div>
                    </CardContent>
                ...
                >
                  ...
                  {project.tech && (
                      ...
                      {project.tech.split(", ").map((tech, techIndex) => (
                            <div key={techIndex} className="flex items-center space-x-2 bg-gray-50 px-3 py-1.5 rounded-full">
                              <Image
                ...
                >
                  <CardContent className="p-8">
                    <div className="flex flex-col items-center text-center space-y-4">
                      ...
                      <span className="text-xl font-medium text-gray-800">{membership}</span>
                  </div>
                </CardContent>
              </Card>
            ))}
      ...
      >
        <div className="container mx-auto max-w-4xl text-center">
          <div className="flex justify-center space-x-8 mb-8">
            <a href="#" className="text-gray-600 hover:text-pink-500 transition-colors transform hover:scale-110">
              <Github size={28} />
            </a>
            <a href="#" className="text-gray-600 hover:text-pink-500 transition-colors transform hover:scale-110">
              <Linkedin size={28} />
          ...
          <p className="text-gray-600 text-lg flex items-center justify-center">
            Made with <Heart className="text-pink-500 mx-2 animate-pulse" size={20} /> by Angelo
          </p>
        </div>
      </motion.footer>
    </div>
